        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <label class="relative block py-2 w-full">
                <input
                    ...
                    placeholder="Email" type="email" name="email" :value="old('email')" autofocus />
            </label>
            ...
            <div class="flex justify-between py-1 pb-3">
                <div class="form-check">
                    <input
                        ...
                        type="checkbox" name="remember" id="flexCheckDefault">
                    <label class="form-check-label inline-block text-gray-800" for="flexCheckDefault">
                        Remember Me
                    </label>
                </div>
                <div class="text-green-400 hover:text-green-700 active:text-green-800 font-semibold"><a
