                        ...
                        <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                            ...
                            <li class="mb-2">
                                <a class="dropdown-item border-radius-md" href="javascript:;">
                                    <div class="d-flex py-1">
                                        <div class="my-auto">
                                            <img src="/argon/img/small-logos/logo-spotify.svg" class="avatar avatar-sm bg-gradient-dark  me-3 ">
                                        </div>
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="text-sm font-weight-normal mb-1">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Paling laku</p>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Mitra Baru</p>
                                    <h6 class="font-weight-bolder">
                                        +3,462
                                    </h6>
                                ...
                                <div class="">
                                    <table class="table  table-striped border ">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="pt-3">1</td>
                                                <td class="pt-3">Nizamudin</td>
                                                <td class="pt-3">Mitra</td>
                                                <td><button type="button" class="btn btn-danger"><a href="/delete">Delete</a></button><a href="/editadmin"> <button type="button" class="btn btn-Secondary">Edit</button></a></td>
                                            </tr>
                                            <tr>
                                                <td class="pt-3">2</td>
                                                <td class="pt-3">Regita Cahya</td>
                                                <td class="pt-3">Mitra</td>
                                                <td><button type="button" class="btn btn-danger"><a href="/delete">Delete</a></button><a href="/editadmin"> <button type="button" class="btn btn-Secondary">Edit</button></a></td>
                                            </tr>
                                        </tbody>
