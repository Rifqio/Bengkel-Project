...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <br>
        <div class="container">
            <img style="max-width: 50px; height:auto; border-radius:50%;" src="{{ asset('data_user/'.$user->email.'/profile/'.$user->profile_photo_path) }}" alt="{{$user->profile_photo_path}}">
        </div>
        <form method="post" action="{{url('mitra-profile')}}" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
