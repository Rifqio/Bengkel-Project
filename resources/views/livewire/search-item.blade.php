<div class="flex px-5 lg:px-36 py-4">
    ...
    <div class="flex border-2 shadow-sm rounded-lg bg-slate-100 w-full ml-10 lg:ml-0">
        ...
        <div class="rounded-lg w-full ">
            ...
            <form method="get">
                <input wire:model='term' type="text" placeholder="Search for a part..." class="py-3 border-none rounded-r-lg w-full bg-slate-100  focus:ring-green-500 ">
